...
param llm_model_v2 string = 'gpt-5-mini'
...
module llmDeployment_v2 './modules/model-deployment.bicep' = {
  name: 'deploy-llm-model_v2'
  params: {
    aiFoundryName: aiFoundryName
    deploymentName: llm_model_v2
    modelName: llm_model_v2
    modelFormat: 'OpenAI'
...
output LLM_MODEL_DEPLOYMENT_NAME_V2 string = llmDeployment_v2.outputs.deploymentName
